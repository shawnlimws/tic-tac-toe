...
function checkCombination(x, y, z) {
  if (x.innerHTML !== '' && x.innerHTML === y.innerHTML && x.innerHTML === z.innerHTML) {
     ...
     */
    Array.from(document.getElementsByClassName('tile')).forEach(tile => tile.disabled = true);
    Array.from(document.getElementsByClassName('tile')).forEach(tile => tile.className = 'occupied');
...
function resetGame() {
  ...
  Array.from(document.getElementsByClassName('occupied')).forEach(tile => tile.className = 'tile');
}
